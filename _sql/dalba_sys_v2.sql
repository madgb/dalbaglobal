...
--
-- Host: localhost:3306
-- 생성 시간: 25-06-27 01:08
-- 서버 버전: 8.0.42-0ubuntu0.22.04.1
-- PHP 버전: 8.1.2-1ubuntu2.21
...
--
-- 테이블 구조 `tb_achievement_info`
--

CREATE TABLE `tb_achievement_info` (
  `b_idx` int NOT NULL COMMENT 'PK',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Achievement 기본 설정 테이블';

--
-- 테이블의 덤프 데이터 `tb_achievement_info`
--
...
--
-- 테이블 구조 `tb_board_attach`
--

CREATE TABLE `tb_board_attach` (
  `ba_idx` int NOT NULL COMMENT 'PK',
  ...
  `ba_file_size` int DEFAULT NULL COMMENT '첨부파일사이즈',
  `s_dt` datetime DEFAULT NULL COMMENT '등록일'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='게시판  첨부파일 관리';

--
-- 테이블의 덤프 데이터 `tb_board_attach`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='게시판 테이블';
...
(62, 'history', 1, NULL, '3월', '<p>러시아 최대 e-commerce 와일드베리 세럼 카테고리 1위</p>', 0, '220.116.84.234', '', 'Y', 1, NULL, NULL, NULL, NULL, '2025-05-22', NULL, 'N', '2022', 'Mar', '<p>No. 1 in the Serum Category on Wildberries, Russia\'s Largest E-Commerce Platform</p>'),
(63, 'history', 1, NULL, '1월', '<p>쿠팡 선케어, 에신스. 앰플 카테고리 1위</p>', 0, '220.116.84.234', '', 'Y', 1, NULL, NULL, NULL, NULL, '2025-05-22', '2025-05-22 09:44:41', 'N', '2023', 'Jan', '<p>No. 1 in the Sun Care, Essence, and Ampoule Categories on Coupang</p>'),
(64, 'history', 1, NULL, '1월', '<p>미스트 세럼 누적 판매 2,000만개 달성</p>', 0, '220.116.84.234', '', 'Y', 1, NULL, NULL, NULL, NULL, '2025-05-22', NULL, 'N', '2023', 'Jan', '<p>Cumulative Sales of Mist Serum Reach 20 Million Units</p>'),
(65, 'history', 1, NULL, '12월', '<p>미스트 세럼 누적 판매 3,000만개 달성</p>', 0, '220.116.84.234', '', 'Y', 1, NULL, NULL, NULL, NULL, '2025-05-22', NULL, 'N', '2023', 'Dec', '<p>Cumulative Sales of Mist Serum Reach 30 Million Units</p>'),
(66, 'history', 1, NULL, '12월', '<p>수출 1억불 달성(누적 2200억원)</p><p>&nbsp;</p>', 0, '220.116.84.234', '', 'Y', 1, NULL, NULL, NULL, NULL, '2025-05-22', '2025-05-22 09:48:01', 'N', '2024', 'Dec', '<p>Achieved USD 100 million in exports (Cumulative total: KRW 220 billion)</p>'),
(67, 'history', 1, NULL, '12월', '<p>일본 립스 2024 베스트 코스메 1위</p>', 0, '220.116.84.234', '', 'Y', 1, NULL, NULL, NULL, NULL, '2025-05-22', NULL, 'N', '2024', 'Dec', '<p>Ranked No. 1 in Japan\'s LIPS 2024 Best Cosmetics</p>');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='회원관리';
...
--
-- 테이블의 인덱스 `tb_achievement_info`
--
ALTER TABLE `tb_achievement_info`
  ADD PRIMARY KEY (`b_idx`);

--
-- 테이블의 인덱스 `tb_announcement`
--
...
--
-- 테이블의 인덱스 `tb_board_attach`
--
ALTER TABLE `tb_board_attach`
  ADD PRIMARY KEY (`ba_idx`),
  ADD KEY `idx_board_attach_b_idx` (`b_idx`);
...
--
-- 테이블의 AUTO_INCREMENT `tb_achievement_info`
--
ALTER TABLE `tb_achievement_info`
  MODIFY `b_idx` int NOT NULL AUTO_INCREMENT COMMENT 'PK', AUTO_INCREMENT=2;

--
-- 테이블의 AUTO_INCREMENT `tb_announcement`
--
ALTER TABLE `tb_announcement`
  MODIFY `a_id` bigint NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `tb_attach`
--
ALTER TABLE `tb_attach`
  MODIFY `at_id` bigint NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `tb_board_attach`
--
ALTER TABLE `tb_board_attach`
  MODIFY `ba_idx` int NOT NULL AUTO_INCREMENT COMMENT 'PK', AUTO_INCREMENT=16;

--
-- 테이블의 AUTO_INCREMENT `tb_board_info`
--
ALTER TABLE `tb_board_info`
  MODIFY `b_idx` int NOT NULL AUTO_INCREMENT COMMENT 'PK', AUTO_INCREMENT=68;

--
-- 테이블의 AUTO_INCREMENT `tb_ir`
--
ALTER TABLE `tb_ir`
  MODIFY `i_id` bigint NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `tb_member`
--
ALTER TABLE `tb_member`
  MODIFY `m_idx` int NOT NULL AUTO_INCREMENT COMMENT 'PK', AUTO_INCREMENT=2;

--
-- 테이블의 AUTO_INCREMENT `tb_news`
--
ALTER TABLE `tb_news`
  MODIFY `n_id` bigint NOT NULL AUTO_INCREMENT;
COMMIT;
