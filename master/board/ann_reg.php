          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Announcements 등록</h4>
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Announcements</a></li>
                    <li class="breadcrumb-item active">Announcements 등록</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form name="regForm" id="regForm" method="POST" action="javascript:void(0);" novalidate>
                    ...
                    <input type="hidden" name="bbs_cd" id="bbs_cd" value="announcements">
                    ...
                    <div class="table-responsive table-responsive-detail">
                      ...
                      <table class="table align-middle table-nowrap mb-0 table_detail">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th>날짜<span class="asterisk">*</span></th>
                            <td>
                              <div class="d-flex align-items-center gap-2">
                                <input type="date" class="form-control form-date" placeholder="" id="w_ymd" name="w_ymd" value="<?php echo isset($rw) ? $rw['w_ymd']:""?>" required msg="날짜">
                              </div>
                              </div>
                            </td>
                          </tr>
                    ...
                    <div class="d-flex justify-content-end align-items-center mt-3 gap-2">
                      <a href="./ann_list.php" class="btn btn-md btn-light w-md">취소</a>
