...
try {
    ...
    $quOpt = "SELECT DISTINCT w_year FROM tb_board_info WHERE bbs_cd ='history' AND is_del = 'N' order by w_year DESC";
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1">History 검색</h4>
                </div><!-- end card header -->
                <div class="card-body">
                  <div class="live-preview">
                    <form name="srhFrm" id="srhFrm" action="javascript:void(0);" class="form_search">
                      <input type="hidden" name="bbs_category" id="bbs_category" value="history">
          ...
          <div class="row">
            <div class="list_info">
              ...
              <div class="list_sort_btns">
                ...
                <div class="btns">
                  <a href="./history_reg.php" class="btn btn-success w-md waves-danger waves-light">등록</a>
                </div>
              </div>
            </div>
          </div>
