          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">IR Material</h4>
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">IR Material</li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1">IR Material 검색</h4>
                </div><!-- end card header -->
                <div class="card-body">
                        ...
                        <div class="select_input_box col-auto">
                          <div class="col-auto">
                            ...
                            <select class="form-select" id="srhField" name="srhField">
                              ...
                              <option value="ir_results">results</option>
                              <option value="ir_presentations">presentations</option>
                              <option value="ir_others">others</option>
                            </select>
                          </div>
          ...
          <div class="row">
            <div class="list_info">
              ...
              <div class="list_sort_btns">
                ...
                <div class="btns">
                  <a href="./ir_reg.php" class="btn btn-success w-md waves-danger waves-light">등록</a>
                </div>
              </div>
            </div>
          </div>
