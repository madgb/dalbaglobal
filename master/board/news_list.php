            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1">News 검색</h4>
                </div><!-- end card header -->
                <div class="card-body">
                        ...
                        <div class="select_input_box col-auto">
                          <div class="col-auto">
														...
														<select class="form-select" id="srhField" name="srhField">
															...
															<option value='news_corp'>corp</option>
															<option value='news_brand'>brand</option>
															<option value='news_blog'>blog</option>
															<option value='news_career'>career</option>
															<option value='news_others'>others</option>
          ...
          <div class="row">
            <div class="list_info">
              ...
              <div class="list_sort_btns">
                ...
                <div class="btns">
                  <a href="./news_reg.php" class="btn btn-success w-md waves-danger waves-light">등록</a>
                </div>
              </div>
            </div>
          </div>
