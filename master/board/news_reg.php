          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Newsroom 등록</h4>
                <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Newsroom</a></li>
                    <li class="breadcrumb-item active">Newsroom 등록</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form name="regForm" id="regForm" method="POST" action="javascript:void(0);" novalidate>
                    <input type="hidden" name="bbs_category" id="bbs_category" value="news">
                    ...
                    <div class="table-responsive table-responsive-detail">
                      ...
                      <table class="table align-middle table-nowrap mb-0 table_detail">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td colspan="3">
                              <div class="d-flex align-items-center gap-2">
                                ...
                                <option value='news_corp' <?PHP echo $rw['bbs_cd'] == "news_corp" ? "selected" : ""?>>corp</option>
                                <option value='news_brand' <?PHP echo $rw['bbs_cd'] == "news_brand" ? "selected" : ""?>>brand</option>
                                <option value='news_blog' <?PHP echo $rw['bbs_cd'] == "news_blog" ? "selected" : ""?>>blog</option>
                                <option value='news_career' <?PHP echo $rw['bbs_cd'] == "news_career" ? "selected" : ""?>>career</option>
                                <option value='news_others' <?PHP echo $rw['bbs_cd'] == "news_others" ? "selected" : ""?>>others</option>
                              </select>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <th>등록일<span class="asterisk">*</span></th>
                            <td colspan="3">
                              <div class="d-flex align-items-center gap-2">
                          ...
                          <!-- <tr>
                            ...
                            <td>
                              ...
                              <ul class="select_file_list" id="selectedFileList"></ul>
                            </td>
                          </tr> -->
                        </tbody>
                      </table>
                    ...
                    <a href="./news_list.php" class="btn btn-md btn-light w-md">취소</a>
