...
//   // $query = "SELECT t1.*, t2.* FROM tb_board_info t1 LEFT JOIN tb_board_attach t2 ON t1.b_idx = t2.b_idx WHERE t1.bbs_cd LIKE '" .$bbs_cd . "' ORDER BY t1.w_dt desc LIMIT 5";
  
//   $query = "SELECT * FROM tb_board_info WHERE bbs_cd LIKE '"$bbs_cd . "' ORDER BY w_dt DESC LIMIT 5";
...
// $irList = fetchData($DB, "ir%");
// $annoucmentList = fetchData($DB, "announcements");
// $newsList = fetchData($DB, "news%");
...
<html lang="ko">
  <head>
    ...
    <meta property="og:title" content="d`Alva" />
    <meta property="og:description" content="d`Alva" />
    ...
    <div id="wrap">
      <header class="header">
        <div class="header__inner">
          ...
          <div class="global">
            <button type="button" class="global_btn"></button>
            <ul class="global_ul">
              <li class="on">KO</li>
              <li>EN</li>
            </ul>
        ...
        <div class="pc_sidebar__inner">
          ...
          <nav class="p_sidebar">
            <ul class="sidebar_ul">
              ...
              <li>
                <button class="btn-lnb">Investors</button>
                <ul class="lnb__list">
                  <li><a href="#IR_Material">IR Material</a></li>
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide slide01 home" id="home">
                <div class="video_main">
                  <video class="video" autoplay muted playsinline loop>
                    <source type="video/mp4" src="./_img/common/main_video.mp4" />
                  </video>
                </div>
                <div class="text">
                  <h1>
              ...
              <div class="swiper-slide slide02 mission" id="mission">
                <div class="video_2">
                  <video class="video" autoplay muted playsinline loop>
                    <source type="video/mp4" src="./_img/common/Mission_white.mp4" />
                  </video>
                </div>
                <div class="text">
                  <h2>Mission</h2>
                  <p>
                    고객 라이프스타일 영역에서<br class="pc_show" />
              ...
              <div class="swiper-slide slide03 history" id="history">
                <!-- pc-history start -->
                <div class="history_inner">
                  <div class="cont">
                    ...
                    <div class="box">
                      ...
                      <div class="detail 2024">
                        <div class="item">
                          <h3>12월</h3>
                          <ol>
                            <li>수출 1억불 달성(누적 2200억원)</li>
                            <li>일본 립스 2024 베스트 코스메 1위</li>
                            <li>일본 아마존/앳코스메 미스트 카테고리 1위</li>
                            <li>베트남 쇼피 스킨케어 카테고리 Top 3</li>
                            <li>독일/스페인 아마존 Sunscreens 카테고리 1위</li>
                          </ol>
                        </div>
                        <div class="item">
                          <h3>2H</h3>
                          <ol>
                            <li>미스트 세럼 누적 판매 4,000만개 달성</li>
                            <li>선크림 누적 판매 1,000만개 달성</li>
                          </ol>
                        </div>
                        <div class="item">
                          <h3>7월</h3>
                          <ol>
                            <li>
                              미국/캐나다/독일/스페인/호주/영국 아마존 미스트 세럼<br />
                              Face Mist 카테고리 1위
                            </li>
                            <li>일본 큐텐 미스트 카테고리, 선크림 UV 케어 카테고리 1위</li>
                            <li>
                              일본 라쿠텐 세럼 토너 스킨케어 카테고리 1위,<br />
                              모델링 마스크 카테고리 1위
                            </li>
                          </ol>
                        </div>
                        <div class="item">
                          <h3>6월</h3>
                          <ol>
                            <li>올영세일 스킨케어 1위 (화이트 트러플 퍼스트 스프레이 세럼)</li>
                          </ol>
                        </div>
                        <div class="item">
                          <h3>1H</h3>
                          <ol>
                            <li>네이버 뷰티 전체 카테고리 내 거래액 1위</li>
                            <li>
                              쿠팡 에센스 부분 베스트 제품 수상<br />
                              (화이트 트러플 수프림 세럼)
                            </li>
                            <li>
                              올리브영 스킨케어 전체 제품 판매량 Top 3<br />
                              (화이트 트러플 퍼스트 스프레이 세럼)
                            </li>
                          </ol>
                        </div>
                      ...
                      <div class="detail 2023">
                        <div class="item">
                          <h3>12월</h3>
                          <ol>
                            <li>미스트 세럼 누적 판매 3,000만개 달성</li>
                          </ol>
                        </div>
                        <div class="item">
                          <h3>1월</h3>
                          <ol>
                            <li>쿠팡 선케어/에센스/앰플 카테고리 1위</li>
                          </ol>
                        </div>
                        <div class="item">
                          <h3>1월</h3>
                          <ol>
                            <li>미스트 세럼 누적 판매 2,000만개 달성</li>
                          </ol>
                        </div>
                      </div>
                      <div class="detail 2022">
                        <div class="item">
                          <h3>3월</h3>
                          <ol>
                            <li>러시아 최대 e-commerce 와일드베리 세럼 카테고리 1위</li>
                          </ol>
                        </div>
                      </div>
                      <div class="detail 2021">
                        <div class="item">
                          <h3>12월</h3>
                          <ol>
                            <li>미스트 세럼 누적 판매 1,000만개 달성</li>
                          </ol>
                        </div>
                      </div>
                    </div>
                ...
                <div class="mo_his_inner history">
                  <div class="cont">
                    <h1>History</h1>
                    <ul class="year_btn">
                      <li><a href="#tab01">2024</a></li>
                      <li><a href="#tab02">2023</a></li>
                      <li><a href="#tab03">2022</a></li>
                      <li><a href="#tab04">2021</a></li>
                    </ul>
                    <div class="tabcontent">
                      <div id="tab01" class="year_detail">
                        <div class="item">
                          <h3>12월</h3>
                          <ol>
                            <li>수출 1억불 달성(누적 2200억원)</li>
                        ...
                        <div class="item">
                          <h3>7월</h3>
                          <ol>
                            <li>미국/캐나다/독일/스페인/호주/영국 아마존 미스트 세럼 Face Mist 카테고리 1위</li>
                            <li>일본 큐텐 미스트 카테고리, 선크림 UV 케어 카테고리 1위</li>
                            <li>일본 라쿠텐 세럼 토너 스킨케어 카테고리 1위, 모델링 마스크 카테고리 1위</li>
                          </ol>
                        </div>
                        <div class="item">
                          <h3>6월</h3>
                        ...
                        <div class="item">
                          ...
                          <ol>
                            <li>네이버 뷰티 전체 카테고리 내 거래액 1위</li>
                            <li>쿠팡 에센스 부분 베스트 제품 수상 (화이트 트러플 수프림 세럼)</li>
                            <li>올리브영 스킨케어 전체 제품 판매량 Top 3 (화이트 트러플 퍼스트 스프레이 세럼)</li>
                          </ol>
                        </div>
                      </div>
                      <div id="tab02" class="year_detail">
                        <div class="item">
                          <h3>12월</h3>
                          <ol>
                            <li>미스트 세럼 누적 판매 3,000만개 달성</li>
                      ...
                      <div id="tab03" class="year_detail">
                        <div class="item">
                          <h3>3월</h3>
                          <ol>
                            <li>러시아 최대 e-commerce 와일드베리 세럼 카테고리 1위</li>
                      ...
                      <div id="tab04" class="year_detail">
                        <div class="item">
                          <h3>12월</h3>
                          <ol>
                            <li>미스트 세럼 누적 판매 1,000만개 달성</li>
              ...
              <div class="swiper-slide slide04 career" id="career">
                <div class="video_2">
                  <video class="video" autoplay muted playsinline loop>
                    <source type="video/mp4" src="./_img/common/Career2.mp4" />
                  </video>
                </div>
                <div class="text">
                  <h2>Career</h2>
              ...
              <ul class="ir_ul">
                ...
                <li>
                  ...
                  <div class="file">
                    ...
                    <a href="<?php echo (strpos($row['url'], 'http') === false ? 'http://' : '') . htmlspecialchars($row['url']) ?>" class="link_go">링크 바로가기</a>
                  </div>
                </li>
                <?php } ?>
              </ul>
              <!-- <button type="button" class="btn" data-offset="5">더보기</button> -->
              <button type="button" class="btn" data-bbs="ir%" data-offset="5" <?= ($irData['total_count'] <= 5) ? 'style="display:none;"' : '' ?>>더보기</button>
            </div>
          </div>
          <div class="section_2 Announcements" id="Announcements">
            <div class="ir_inner">
              ...
              <div class="select_box">
                <select name="" id="" class="nice-select select-primary">
              ...
              <ul class="ir_ul">
              <?php foreach($annoucmentList as $row) {?>
                <li>
                  <div class="title">
              ...
              <button type="button" class="btn" data-bbs="announcements" data-offset="5" <?= ($announcementData['total_count'] <= 5) ? 'style="display:none;"' : '' ?>>더보기</button>
            </div>
          </div>
          <div class="section_2 Newsroom" id="Newsroom">
            <div class="ir_inner">
              ...
              <div class="radio-btns news">
                <label for="All" class="radio--typeA"><input type="radio" name="news" id="All" checked /><em>All</em></label>
                ...
                <label for="new-Others" class="radio--typeA"><input type="radio" name="news" id="new-Others" /><em>Others</em></label>
              </div>
              ...
              <button type="button" class="btn" data-bbs="news%" data-offset="5" <?= ($newsData['total_count'] <= 5) ? 'style="display:none;"' : '' ?>>더보기</button>
            </div>
          </div>
          <footer class="footer">
